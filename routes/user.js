...
router.get("/shopPage",controller.shopPage)
router.get("/category_product",controller.categoryProduct)
...
router.post("/remove-product/:id", controller.deleteCart);
router.post("/remove-wishproduct/:id", controller.deleteWishlist);
